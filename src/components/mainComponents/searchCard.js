...
class SearchCard extends Component{
  ...
  render(){
    return(
      <div className= "container-fluid bg-dark text-right">
        <div className= "row">
          {this.state.searchedSeller.length == 0 ?  
            <h1 className="text-warning">{this.props.match.params.name} seller not found</h1>:
